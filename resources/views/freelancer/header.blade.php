...
<div class="nav-header">
    <a href="index.php" class="brand-logo">
        ...
        <img class="logo-compact" src="xhtml/images/logo-text1.png" alt="">
        <img class="brand-title" src="/xhtml/images/logo-text1.png" alt="">
    </a>
                    ...
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                            <div class="header-info">
                                ...
                                <p class="fs-12 mb-0">Freelancer</p>
                            </div>
...
<div class="deznav">
    <div class="deznav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li><a class="ai-icon" href="{{ asset('project') }}">
        ...
        <div class="copyright">
            <p><strong>Freelancing Portal freelancer dashboard</strong> © 2021 All Rights Reserved</p>
