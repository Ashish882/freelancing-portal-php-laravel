        ...
        <div class="content-body">
			...
			<div class="container-fluid">
				...
				<div class="d-flex pb-3 mb-4 border-bottom flex-wrap align-items-center">
					<span class="d-block mr-4 mb-2">Suggestions</span>
					<a href="javascript:void(0);" class="btn btn-secondary light btn-rounded mr-2 mb-2">Your Skill</a>
					<a href="javascript:void(0);" class="btn btn-secondary light btn-rounded mr-2 mb-2">Software Engineer</a>
					<a href="javascript:void(0);" class="btn btn-secondary btn-rounded mr-2 mb-2">UX Designer</a>
					<a href="javascript:void(0);" class="btn btn-secondary light btn-rounded mr-2 mb-2">Photographer</a>
					<a href="javascript:void(0);" class="btn btn-secondary light btn-rounded mr-2 mb-2">Digital Marketing</a>
				</div>-->
